    ...
    <main class="main-content">
                ...
                <section class="product-section">
                    <div class="product-container">
                        <div class="product-image">
                            <a href="product_detail.php?id=<?php echo $product['id']; ?>"><img
                                    src="<?php echo htmlspecialchars($product['image_url'] ?? '../assets/images/product_gallery/1.jpg'); ?>"
                                    alt="<?php echo htmlspecialchars($product['name']); ?>"
                                    onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';"></a>
                        </div>
                        <div class="product-details">
                            <h2><?php echo htmlspecialchars($product['name']); ?></h2>
                            <p><?php echo htmlspecialchars(substr($product['description'] ?? 'This is an awesome product that you can buy today. It has excellent features and is a must-have!', 0, 100)); ?>...
                            </p>
                            <p class="price">₹<?php echo number_format($product['price'] ?? 0); ?></p>
                            <button class="buy-btn"
                                data-product-name="<?php echo addslashes(htmlspecialchars($product['name'])); ?>"
                                data-product-price="<?php echo $product['price'] ?? 0; ?>">Buy Now</button>
                        </div>
                    </div>
                </section>
            <?php endforeach; ?>
        <?php else: ?>
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <a href="product_detail.php"><img src="../assets/images/product_gallery/1.jpg" alt="Product Image"
                                onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';"></a>
                    </div>
                    <div class="product-details">
                        <h2>Bose SoundLink Micro speaker</h2>
                        <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!
                        </p>
                        <p class="price">₹2999</p>
                        <button class="buy-btn" data-product-name="Bose SoundLink Micro speaker"
                            data-product-price="2999">Buy Now</button>
                    </div>
                </div>
            </section>
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <img src="../assets/images/product_gallery/2.jpg" alt="Product Image"
                    ...
                    <div class="product-details">
                        ...
                        <button class="buy-btn" data-product-name="Soundcore Motion 300" data-product-price="3999">Buy
                            Now</button>
                    </div>
                </div>
            </section>
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <img src="../assets/images/product_gallery/3.jpg" alt="Product Image"
                            onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                    </div>
                    <div class="product-details">
                        ...
                        <button class="buy-btn" data-product-name="Denon Envaya DSB-250BT" data-product-price="4999">Buy
                            Now</button>
                    </div>
                </div>
            </section>
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <img src="../assets/images/product_gallery/4.jpg" alt="Product Image"
                            onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                    </div>
                    <div class="product-details">
                        ...
                        <button class="buy-btn" data-product-name="Marshall MIDDLETON" data-product-price="8999">Buy
                            Now</button>
                    </div>
                </div>
            </section>
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <img src="../assets/images/product_gallery/5.jpg" alt="Product Image"
                            onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                    </div>
                    <div class="product-details">
                        ...
                        <button class="buy-btn" data-product-name="Marshall Acton Bluetooth speaker"
                            data-product-price="12999">Buy Now</button>
                    </div>
                </div>
            </section>
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <img src="../assets/images/product_gallery/23.jpg" alt="Product Image"
                            onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                    </div>
                    <div class="product-details">
                        <h2>JBL Clip-4</h2>
            ...
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <img src="../assets/images/product_gallery/7.jpg" alt="Product Image"
                            onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                    </div>
                    <div class="product-details">
                        ...
                        <button class="buy-btn" data-product-name="Sony PUMPX (SRS-X2)" data-product-price="2499">Buy
                            Now</button>
                    </div>
                </div>
            </section>
            <section class="product-section">
                <div class="product-container">
                    <div class="product-image">
                        <img src="../assets/images/product_gallery/34.jpg" alt="Product Image"
                            onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                    </div>
                    <div class="product-details">
                        ...
                        <button class="buy-btn" data-product-name="pTron Fusion Go 10W" data-product-price="1499">Buy
                            Now</button>
                    </div>
                </div>
            </section>
